...
1. Languages — programming languages (C++, Python, JS, HTML, CSS, PHP, Assembly, MySQL)
2. ML & Data — ML tools (Python/Colab, scikit-learn, TensorFlow, Kaggle)
3. Design Tools — design software (Figma, Canva)
4. Tools & Platforms — dev tools (GitHub, Cisco Packet Tracer, XAMPP)
